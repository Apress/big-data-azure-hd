...
namespace TwitterStreaming.Bolt
{
    ...
    /// </summary>
    public class AzureSqlBolt : ISCPBolt
    {
        ...
        public AzureSqlBolt(Context context, Dictionary<string, Object> parms)
        {
            //Set the context
            this.context = context;

            Dictionary<string, List<Type>> inputSchema = new Dictionary<string, List<Type>>();
            inputSchema.Add("TOPNTWEETS_STREAM", TopNTweetBolt.OutputSchema);
        ...
        public static AzureSqlBolt Get(Context context, Dictionary<string, Object> parms)
        {
            return new AzureSqlBolt(context, parms);
        }
